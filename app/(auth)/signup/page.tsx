...
export default function SignupPage() {
  ...
  return (
    <form
      ...
      noValidate
      className="glass-card-strong flex w-full flex-col rounded-[28px]"
      style={{
        maxHeight: "calc(100dvh - max(env(safe-area-inset-top), 32px) - 32px)",
      }}
    >
      ...
      <div
        ...
        style={{ borderTop: "1px solid rgb(var(--glass-accent) / 0.1)" }}
      >
        ...
        <button
          ...
          className="glass-pill-dark flex w-full items-center justify-center rounded-2xl text-white disabled:opacity-60"
